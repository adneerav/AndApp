 ...
 */
public class CalendarT extends BaseFragmentT {
    public static final String TAG = "CalendarT";

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.calendar_screen_t, container, false);
    }
